...
public:
  ...
  dynamic_parameter_base(const std::shared_ptr<detail::dynamic_parameter_impl>& impl);
...
class __SYCL_EXPORT dynamic_local_accessor_base: public dynamic_parameter_base {
public:
  dynamic_local_accessor_base() = default;

  dynamic_local_accessor_base(
      experimental::command_graph<graph_state::modifiable> Graph,
      sycl::range<3> AllocationSize, int Dims, int ElemSize, const property_list &PropList);
...
public:
  ...
  dynamic_local_accessor(
      ...
      : detail::dynamic_local_accessor_base(
            Graph, detail::convertToArrayOfN<3, 1>(AllocationSize), Dimensions,
