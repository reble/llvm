...
int main() {
  ...
  exp_ext::dynamic_local_accessor<T, 2> DynLocalMemA{Graph, range<2>{LocalSize, LocalSize}};
  exp_ext::dynamic_local_accessor<T, 1> DynLocalMemC{Graph, range<1>{LocalSize}};
