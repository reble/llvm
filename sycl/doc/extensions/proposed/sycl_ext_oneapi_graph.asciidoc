...
the SYCL runtime, a SYCL function for invoking kernels or for explicit memory 
operations, with all restrictions that apply as described in the core specification.
