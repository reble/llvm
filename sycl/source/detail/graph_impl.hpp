...
public:
  dynamic_work_group_memory_impl(std::shared_ptr<graph_impl> GraphImpl,
...
public:
  dynamic_local_accessor_impl(std::shared_ptr<graph_impl> GraphImpl,
                              sycl::range<3> AllocationSize, int Dims,
