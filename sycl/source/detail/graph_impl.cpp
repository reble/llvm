...
dynamic_work_group_memory_base::dynamic_work_group_memory_base(
    ...
    : dynamic_parameter_base(std::make_shared<dynamic_work_group_memory_impl>(
          sycl::detail::getSyclObjImpl(Graph), BufferSizeInBytes)) {}
...
dynamic_local_accessor_base::dynamic_local_accessor_base(
    ...
    : dynamic_parameter_base(std::make_shared<dynamic_local_accessor_impl>(
          sycl::detail::getSyclObjImpl(Graph), AllocationSize, Dims, ElemSize,
          PropList)) {}
...
dynamic_local_accessor_impl::dynamic_local_accessor_impl(
    std::shared_ptr<graph_impl> GraphImpl, sycl::range<3> AllocationSize,
    int Dims, int ElemSize, const property_list &PropList)
    : dynamic_parameter_impl(GraphImpl),
