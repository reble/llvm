...
void handler::processArg(void *Ptr, const detail::kernel_param_kind_t &Kind,
  ...
  case kernel_param_kind_t::kind_dynamic_accessor: {
    ...
    case access::target::local: {
      ...
      auto *DynLocalAccessorImpl = static_cast<ext::oneapi::experimental::detail::dynamic_local_accessor_impl *>(DynParamImpl);

      addArgsForLocalAccessor(
          &DynLocalAccessorImpl->LAccImplHost, Index, IndexShift, IsKernelCreatedFromSource, impl->MArgs, IsESIMD);
      break;
    }
    default: {
  ...
  case kernel_param_kind_t::kind_dynamic_work_group_memory: {
    ...
    auto *DynWorkGroupImpl = static_cast<ext::oneapi::experimental::detail::dynamic_work_group_memory_impl *>(DynParamImpl);
...
void handler::extractArgsAndReqsFromLambda(
  ...
  for (size_t I = 0; I < NumKernelParams; ++I) {
    ...
    if (Kind == detail::kernel_param_kind_t::kind_accessor) {
      ...
      ext::oneapi::experimental::detail::dynamic_parameter_base
          *DynamicParamBase =
              static_cast<ext::oneapi::experimental::detail::
                              dynamic_parameter_base *>(Ptr);
      Ptr = detail::getSyclObjImpl(*DynamicParamBase).get();
    }
